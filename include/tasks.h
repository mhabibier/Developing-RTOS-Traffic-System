...
void IRAM_ATTR isrVehicle_E(void); ///< ISR tombol kendaraan normal — Jalur Timur (GPIO 12)
void IRAM_ATTR isrVehicle_W(void); ///< ISR tombol kendaraan normal — Jalur Barat (GPIO 15)

/* ─────────────────────────────────────────────────────────────
 * 4. ISR — KENDARAAN DARURAT
 *    Mode     : FALLING (tombol tekan → pin LOW via ext. pull-up 10kΩ)
